<template>
  <div class="app-container">
    <div class="page-hero"><div class="hero-inner"><div class="hero-text">
      ...
      <p class="hero-desc">多组相关样本（配对/区组设计）的非参数检验，对每个区组内各处理值排秩，检验各处理间秩和是否有差异，是随机区组方差分析的非参数替代</p>
    ...
    <el-row :gutter="20" class="mb-4 input-row">
      <el-col :lg="16" :xs="24"><el-card shadow="never" class="input-card">
        <el-form label-position="top"><el-form-item label="数据（每行一个区组/受试者，列为不同处理，逗号分隔）"><el-input v-model="form.rawData" type="textarea" :rows="5" placeholder="受试者1：处理A值,处理B值,处理C值&#10;受试者2：..." /></el-form-item></el-form>
      ...
      <el-col :lg="8" :xs="24"><div class="param-sidebar"><div class="param-sidebar-header"><el-icon class="sidebar-icon"><InfoFilled /></el-icon>检验原理</div>
        <div class="principle-content">
          <div class="principle-block"><div class="principle-label">假设检验</div><p>H₀: 各处理效果相同</p></div>
          <div class="principle-block"><div class="principle-label">检验统计量</div><div class="formula-box">M = 12/(nk(k+1)) × ΣRⱼ² − 3n(k+1)</div></div>
        </div>
        <div class="ref-section"><div class="ref-title">参考文献</div><p class="ref-item">[1] 方积乾.《卫生统计学》第7版, 2012.</p><p class="ref-item">[2] Friedman M. JASA, 1937.</p></div>
      </div></el-col>
    </el-row>
