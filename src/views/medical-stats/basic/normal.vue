    ...
    <div class="page-hero">
      <div class="hero-inner">
        <div class="hero-text">
          ...
          <p class="hero-desc">计算正态分布的概率密度、累积概率，生成 PDF/CDF 曲线</p>
        </div>
        ...
        <el-card shadow="never" class="input-card">
          <div class="ff-table-area">
            <table class="fourfold-table">
              <thead>
                <tr><th>均值 (μ)</th><th>标准差 (σ)</th><th>X 值</th></tr>
              </thead>
              <tbody>
                <tr>
                  <td class="ft-input"><el-input-number v-model="mu" :step="1" :controls="false" class="fourfold-input" /></td>
                  <td class="ft-input"><el-input-number v-model="sigma" :min="0.01" :step="1" :controls="false" class="fourfold-input" /></td>
                  <td class="ft-input"><el-input-number v-model="xVal" :step="0.5" :controls="false" class="fourfold-input" /></td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <el-col :lg="8" :xs="24">
        <div class="param-sidebar">
          ...
          <div class="principle-content">
            <div class="principle-block"><div class="principle-label">概率密度 f(x)</div><p>正态曲线在 x 处的高度值</p></div>
            <div class="principle-block"><div class="principle-label">累积概率 P(X≤x)</div><p>X 取值不超过 x 的概率</p></div>
        ...
        <el-row :gutter="20" class="mb-4">
          <el-col :lg="12" :xs="24" class="mb-4">
            <el-card shadow="never" class="detail-card">
              <template #header><div class="card-header-inner"><el-icon class="header-icon"><TrendCharts /></el-icon><span class="font-bold">概率密度曲线 (PDF)</span></div></template>
              <ECharts :options="pdfOpts" height="320px" />
            </el-card>
          </el-col>
          <el-col :lg="12" :xs="24" class="mb-4">
            <el-card shadow="never" class="detail-card">
              <template #header><div class="card-header-inner"><el-icon class="header-icon"><TrendCharts /></el-icon><span class="font-bold">累积分布曲线 (CDF)</span></div></template>
...
function calculate() {
  ...
  resultMetrics.value = [
    ...
    { label: `P(X > ${xVal.value})`, value: S.fmt(1 - cdf, 6), type: "warning" },
...
.page-hero::before { content: "N"; position: absolute; right: 40px; top: 50%; transform: translateY(-50%); font-size: 120px; font-weight: 900; opacity: 0.04; color: var(--el-color-primary); font-family: "Georgia", serif; pointer-events: none; }
...
.fourfold-table { width: 100%; max-width: 500px; border-collapse: collapse; font-size: 14px; }
