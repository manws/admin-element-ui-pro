  ...
  <div class="app-container random-sblock">
    ...
    <el-card shadow="never" class="mb-4">
      ...
      <div class="algo-body">
        <h3>分层区组随机算法</h3>
        <el-row :gutter="24">
          <el-col :lg="8" :xs="24"><h4>算法定义</h4><p>先根据多个关键基线因素把受试者划分到不同<strong>分层组合</strong>中，再在每个分层组合内部独立执行<strong>区组随机</strong>。</p></el-col>
          <el-col :lg="8" :xs="24"><h4>适用场景</h4><ul><li>样本量有限，但关注多个关键二分类协变量。</li><li>需要同时控制性别、年龄段、中心等因素的平衡。</li></ul></el-col>
          <el-col :lg="8" :xs="24"><h4>方法特点</h4><ul><li><strong>优点</strong>：多维度提升组间均衡性。</li><li><strong>风险</strong>：因素增多时组合数快速增加。</li></ul></el-col>
        </el-row>
      </div>
    </el-card>
