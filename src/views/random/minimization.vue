<template>
  <div class="app-container random-min">
    ...
    <div class="page-hero mb-4">
      <div class="hero-text">
        <h1 class="hero-title">最小化随机</h1>
        <p class="hero-desc">动态比较失衡分，优先选择更有利于整体平衡的分组</p>
      </div>
      <el-tag class="hero-tag" effect="plain" size="large" round>MINIMIZATION</el-tag>
      <div class="hero-watermark">MR</div>
    </div>
      ...
      <el-col :lg="16" :xs="24">
        <div class="algo-card">
          ...
          <div class="algo-body">
            <h3>最小化随机算法</h3>
            <h4>算法定义</h4>
            <p>最小化随机是一种<strong>动态平衡分配方法</strong>。每有 1 名受试者入组，系统都会根据其当前协变量水平，分别计算"若分配到 A 组"和"若分配到 B 组"后会带来的总失衡分，再优先选择更有利于整体平衡的一组。</p>
            <h4>适用场景</h4>
            <ul>
              <li>样本量相对有限，但希望在入组过程中持续控制多个关键基线因素的组间平衡。</li>
              <li>需要用教学或演示方式直观展示"逐例比较失衡分并动态分配"的随机过程。</li>
            </ul>
            <h4>方法特点</h4>
            <ul>
              <li><strong>优点</strong>：能在整体样本量不大时，更稳定地兼顾多个关键因素的平衡。</li>
              <li><strong>风险</strong>：若优选概率设置过高，分配过程会更接近确定性。</li>
            </ul>
          </div>
        </div>
      </el-col>
    ...
    <div class="sim-card mb-4">
      <div class="sim-card-header">
        ...
        <span class="sim-card-hint">动态比较进入 A/B 组后的总失衡分</span>
      </div>
    ...
    <el-row :gutter="16" class="mb-4">
      ...
      <el-col :lg="6" :md="6" :xs="12"><div class="metric-card mc-amber" data-watermark="F"><div class="mc-content"><div class="mc-label">因素水平数</div><div class="mc-value">{{ res.levelCount }}</div><div class="mc-sub">{{ res.factorCount }} 个因素</div></div><div class="mc-icon"><div class="i-svg:el-icon-Grid" /></div></div></el-col>
      <el-col :lg="6" :md="6" :xs="12"><div class="metric-card mc-neutral" data-watermark="→"><div class="mc-content"><div class="mc-label">优选分配次数</div><div class="mc-value">{{ res.preferredWins }}</div><div class="mc-sub">平局 {{ res.tieAssignments }} 次</div></div><div class="mc-icon"><div class="i-svg:el-icon-Tickets" /></div></div></el-col>
    </el-row>
